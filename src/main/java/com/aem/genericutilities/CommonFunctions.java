...
public class CommonFunctions {
	...
	public Exceptions m_exceptions;
	...
	public CommonFunctions() throws Throwable {
		...
		wait = new WebDriverWait(glb_Webdriver_driver,
				Long.parseLong(ConfigurationReader.getValue("explicit_wait_timeout_seconds")));
	}
	 ...
	 * @throws Throwable
	 */
	public boolean openApp(String object, String url) {
		...
		try {
			...
			if (url != null) {
				...
				{
					m_exceptions = Exceptions.INVALID_URL_EXCEPTION;
					throw new CommonFunctionsExceptions("Invalid URL. Response code: " + int_response_code + ", URL:" + url, m_exceptions);
				}	
			} 
			else {
				Exceptions m_exceptions = Exceptions.NULL_URL_EXCEPTION;
				throw new CommonFunctionsExceptions(url,m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
			glb_Logger_commonlogs.error("unable to open app.." + e.getMessage());
		}
	 ...
	 * @throws Exception
	 */
	public static int sendGet(String object, String urls) throws Exception {
	...
	public static boolean closeBrowser(String object, String testdata)
		...
		try {
			if (glb_Webdriver_driver != null) {
				...
				throw new CommonFunctionsExceptions("Could not refresh page...", m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
	...
	public boolean dragAndDrop(String v_object, String v_testdata)
		...
		try {
			...
			if ((m_str_source != null) && (m_str_destination != null)) {
				...
				throw new CommonFunctionsExceptions("Source and destination values are null.. Source: " + m_str_source + "Destination: " + m_str_destination, m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
			...
			if (locator != null) {
				if (locator.contains("~")) {
					...
					WebDriverWait wait = new WebDriverWait(
							...
							Integer.parseInt(ConfigurationReader.getValue("explicit_wait_timeout_seconds")));
	 ...
	 * @throws Throwable
	 */
	public static List<WebElement> getObjectFromRepo(String v_str_object){
		/*
	...
	/**
	 * @author Rajdeep date: 02/08/2017
	 * Date of review: Description: This
	 * function is used to wait for ajax call to be completed.
	 * @param: locator string of the ajax element
	 */
	public void waitForAjaxCall(String locator){
		try {
			String ajaxCallTimeout = glb_Properties_objectRepository.getProperty("ajax_call_timeout_sec");
			String pollingTime = glb_Properties_objectRepository.getProperty("ajax_call_plloing_time_sec");
			
			if (glb_Webdriver_driver != null && ajaxCallTimeout != null) {
				FluentWait fwait = new FluentWait(glb_Webdriver_driver);
				fwait.withTimeout(Long.parseLong(ajaxCallTimeout), TimeUnit.SECONDS);
				fwait.pollingEvery(Integer.parseInt(pollingTime), TimeUnit.MILLISECONDS);
				fwait.ignoring(NoSuchElementException.class);
				glb_Logger_commonlogs.error(fwait.withMessage("Fluent Wait timer is expired after waiting for " + ajaxCallTimeout + "seconds."));
				
				Function<String, WebElement> function = new Function <String, WebElement>() {
					public WebElement apply(String locator){
						List<WebElement> elements = getObjectFromRepo(locator);
						if(elements.size()>0){
				...
				glb_Logger_commonlogs.info("Waiting for Page to load...");
			} 
			if(glb_Webdriver_driver == null) {
				throw new CommonFunctionsExceptions(Exceptions.NULL_WEBDRIVER_EXCEPTION);
			}
			if (ajaxCallTimeout == null) {
				throw new CommonFunctionsExceptions("The value of Ajax timeout is not specified..", Exceptions.NULL_VALUE_PASSED_EXCEPTION);
			}
		}
		catch(CommonFunctionsExceptions e){
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
			...
			glb_Logger_commonlogs.error("||ERROR|| Could not wait for ajax call... \nError: " + e.getMessage());
		}
	}
	 ...
	 * @throws Throwable
	 */
	public void highlightWebElement(WebElement element) throws Throwable {
		try {
			if (glb_Webdriver_driver != null) {
				JavascriptExecutor js = (JavascriptExecutor) glb_Webdriver_driver;
				if (element != null) {
				...
				throw new CommonFunctionsExceptions("Null webdriver object..", m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
	 ...
	 * @throws Throwable
	 */
	public boolean verifyElementPresent(String v_str_object,
			String v_str_data) throws Throwable {
		WebElement m_WebElement_element = null;
	 ...
	 * @return: void
	 */
	public  void switchToLatestOpenedWindow(String v_str_object,
			String v_str_data) {
		try {
			glb_Logger_commonlogs
			...
			if (glb_Webdriver_driver != null) {
				...
				Exceptions mExceptions = Exceptions.NULL_WEBDRIVER_EXCEPTION;
				throw new CommonFunctionsExceptions("Webdriver object is null...", m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
	...
	public boolean getCurrentWindowURLAndFindText(String textToFindInURL) {
		boolean bln_text_presence = false;
		try {
			if (glb_Webdriver_driver != null) {
				String windowURL = glb_Webdriver_driver.getCurrentUrl();
				
				if (textToFindInURL == null) {
					throw new CommonFunctionsExceptions("Text To Find in URL is null...", Exceptions.NULL_VALUE_PASSED_EXCEPTION);
				}
				if (windowURL.contains(textToFindInURL)) {
					bln_text_presence = true;
					glb_Logger_commonlogs.info("||PASS|| Text \"" + textToFindInURL + "\" is found in URL: " + windowURL);
				} else {
					glb_Logger_commonlogs.error("||FAIL|| Text \"" + textToFindInURL + "\" is NOT found in URL: " + windowURL);
				}
			}
			else {
				throw new CommonFunctionsExceptions(Exceptions.NULL_WEBDRIVER_EXCEPTION);
			...
			glb_Logger_commonlogs.error("||ERROR|| Unable to get current URL and find text. \nError: " + e.getMessage());
		}
		return bln_text_presence;
	}
	...
	public static boolean waitForElementToBeVisibleLocatedByXpath(
		...
		WebDriverWait wait = new WebDriverWait(glb_Webdriver_driver,
				Long.parseLong(ConfigurationReader.getValue("explicit_wait_timeout_seconds_timeout_seconds")));
		try {
			glb_Logger_commonlogs
				...
				if (locator.contains("~")) {
					...
					WebDriverWait wait = new WebDriverWait(
							...
							Integer.parseInt(ConfigurationReader
									.getValue("explicit_wait_timeout_seconds_timeout_seconds")));
					switch (m_locator_type) {
					case "xpath":
						try {
	 ...
	 *        be switched
	 */
	public void switchToWindowByTitle(String object, String Window_Title) {
		glb_Logger_commonlogs
	...
	public String getCurrentUrl() {
		String str_current_url = null;
		try {
			if (glb_Webdriver_driver != null) {
				str_current_url = glb_Webdriver_driver.getCurrentUrl();
			} else {
				throw new CommonFunctionsExceptions(Exceptions.NULL_WEBDRIVER_EXCEPTION);
			}
		} 
			...
			glb_Logger_commonlogs.error("||ERROR|| Unable to get current url. \nError: " + e.getMessage());
		}
	...
	public void openApplication(String url) throws Throwable {
		try {
			...
			glb_Logger_commonlogs.error(e.getMessage(),e);
		}
	}
	 ...
	 */
	public boolean getTitleAndCompare(String expected_title) {
	 ...
	 */
	public void closesAllWindows(String window, String data) {
	 ...
	 * @throws Throwable
	 */
	public void navigateBack(String object, String data)
			throws Throwable {
	 ...
	 * @throws Throwable
	 */
	public void navigateForWard(String object, String data)
			throws Throwable {
	 ...
	 */
	public void ClearCookies(String object, String data) {
		try {
			if (glb_Webdriver_driver != null) {
	 ...
	 */
	public void switchToDefaultContent(String object, String data) {
		try {
			glb_Logger_commonlogs
	 ...
	 * @param : Object and data : empty string "" ""
	 */
	public void maximizeWindow(String object, String data) {
	 ...
	 * @throws Throwable
	 */
	public void switchToFrameByIndexUnderParentWebElement(
	 ...
	 * @throws IOException
	 */
	public boolean navigateToLink(String v_str_object,String v_str_testdata) throws Throwable {
		...
		try {
			if (v_str_testdata != null) {
				...
				if (m_int_status == 200) {
					...
					throw new CommonFunctionsExceptions("Invalid URL. Response code: " + m_int_status + ", URL:" + v_str_testdata, m_exceptions);
				}
			} else {
				Exceptions m_exceptions = Exceptions.NULL_URL_EXCEPTION;
				throw new CommonFunctionsExceptions(v_str_testdata, m_exceptions);
			}
		} catch (CommonFunctionsExceptions e) {
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
		} catch (Exception e) {
	 ...
	 * @throws IOException
	 */
	private void implicitwait() throws Throwable {
		try {
			if (glb_Webdriver_driver != null
				...
				if (glb_Webdriver_driver == null) {
					m_exceptions = Exceptions.NULL_WEBDRIVER_EXCEPTION;
					throw new CommonFunctionsExceptions("Null webdriver object..", m_exceptions);
				}
	...
	public void waitForPageToLoad() {
		try {
			String pageLoadTimeOut = glb_Properties_objectRepository.getProperty("page_load_timeout_value_min");
			
			if (glb_Webdriver_driver != null && pageLoadTimeOut != null) {
				glb_Webdriver_driver.manage().timeouts().pageLoadTimeout(Long.parseLong(pageLoadTimeOut),TimeUnit.MINUTES);
				glb_Logger_commonlogs.info("Waiting for Page to load...");
			} 
			if(glb_Webdriver_driver == null) {
				throw new CommonFunctionsExceptions(Exceptions.NULL_WEBDRIVER_EXCEPTION);
			...
			if (pageLoadTimeOut == null) {
				throw new CommonFunctionsExceptions("The value of timeout is not specified..", Exceptions.NULL_VALUE_PASSED_EXCEPTION);
			}
		}
		catch(CommonFunctionsExceptions e){
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
			...
			glb_Logger_commonlogs.error("||ERROR|| Could not wait for page to load... \nError: " + e.getMessage());
		}
	}
	...
	public void refreshPage(){
		try {
			if (glb_Webdriver_driver != null) {
				...
				waitForPageToLoad();
				waitForPageToBeReady();
				glb_Logger_commonlogs.info("||PASS|| Refresh page completed successfully...");
			} else if(glb_Webdriver_driver == null) {
				//throwing our own exception
				m_exceptions = Exceptions.NULL_WEBDRIVER_EXCEPTION;
				throw new CommonFunctionsExceptions("||ERROR|| Could not refresh page...", m_exceptions);
			}	
		}
		catch(CommonFunctionsExceptions e){
			glb_Logger_commonlogs.error(e.glb_Exception_Message);
			...
			//printing default exception message
			glb_Logger_commonlogs.error("||ERROR|| Unable to refresh the page... \nError: " + e.getMessage());
		}
	}
	 ...
	 * @throws Throwable
	 */
	public void openBrowser(String v_str_object, String v_str_data)
			throws Throwable {
		String path;
	 ...
	 * @throws Throwable
	 */
	public void navigate(String v_str_object, String v_str_data)
			throws Throwable {
		try {
			if (v_str_data != null) {
	...
	public static void click(String v_str_object, String v_str_data)
		...
		try {
			...
			if (m_WebElement_elements != null) {
				wait.until(
						ExpectedConditions
								.elementToBeClickable(m_WebElement_elements
										.get(0))).click();
	...
	public static void inputTextIntoField(String v_str_object, String v_str_data)
		...
		try {
			...
			if (m_WebElement_elements != null) {
				if (!m_WebElement_elements.get(0).getText().isEmpty()) {
					m_WebElement_elements.get(0).clear();
				}
	 ...
	 * @return void
	 */
	public void switchToWindow(String v_str_object, String v_str_data) {
		try {
			if (v_str_data == null) {
				glb_Logger_commonlogs
						.error("v_str_data passed is null. Hence halting execution...");
	 ...
	 * @throws Throwable
	 */
	public boolean switchToWindowAndFindElement(String v_str_object,
			String v_str_data) throws Throwable {
	...
	public void waitForPageToBeReady() {
		String pageReadyTimeOut = null;
		try {
			if (glb_Webdriver_driver != null) {
				pageReadyTimeOut = glb_Properties_objectRepository.getProperty("page_ready_timeout_value_sec");
				long pageReadyTimeoutValue = Long.parseLong(pageReadyTimeOut);
				
				WebDriverWait wait = new WebDriverWait(glb_Webdriver_driver, pageReadyTimeoutValue);
				wait.until(new Function<WebDriver, Boolean>() {
					public Boolean apply(WebDriver driver) {
						return String.valueOf(((JavascriptExecutor) driver).executeScript("return document.readyState")).equals("complete");
					}
				});
				glb_Logger_commonlogs.info("||PASS|| Page is ready..");
			}else if(glb_Webdriver_driver == null) {
				//throwing our own exception
				m_exceptions = Exceptions.NULL_WEBDRIVER_EXCEPTION;
				throw new CommonFunctionsExceptions("||ERROR|| Could not refresh page...", m_exceptions);
			...
			glb_Logger_commonlogs.error("||ERROR|| Page is not ready even after waiting for " + pageReadyTimeOut + " secs... \nError: " + e.getMessage());
		}	
	}
	 ...
	 * @return
	 */
	private Set<String> getWindowIds() {
